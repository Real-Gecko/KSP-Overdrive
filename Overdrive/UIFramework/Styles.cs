...
namespace Overdrive
{
	internal class Styles
	{
		...
		internal static Texture2D tChecked = new Texture2D (16, 22);
		internal static Texture2D tUnchecked = new Texture2D (16, 22);
		internal static Texture2D tCheckedHover = new Texture2D (16, 22);
		internal static Texture2D tUncheckedHover = new Texture2D (16, 22);
		internal static Texture2D tBorderNew = new Texture2D (20, 20);
...
//			button.border = new RectOffset (15, 15, 8, 8);
			...
			toggle.normal.background = tUnchecked;
			toggle.normal.textColor = Palette.gray60;

			toggle.hover.background = tUncheckedHover;
			toggle.hover.textColor = Palette.yellow;

			toggle.active.background = tUncheckedHover;
			toggle.active.textColor = Palette.yellow;

			toggle.onNormal.background = tChecked;
			toggle.onNormal.textColor = Palette.white;

			toggle.onHover.background = tCheckedHover;
			toggle.onHover.textColor = Palette.yellow;

			toggle.onActive.background = tCheckedHover;
			toggle.onActive.textColor = Palette.yellow;

			toggle.border = new RectOffset (16, 0, 0, 0);
			toggle.padding = new RectOffset (20, 4, 4, 4);
...
//			window.border = Offsets.square2;
		...
		private static void LoadTextures() {
			var bytes = System.IO.File.ReadAllBytes ("GameData/Overdrive/Textures/checked.png");
			tChecked.LoadImage (bytes);

			bytes = System.IO.File.ReadAllBytes ("GameData/Overdrive/Textures/unchecked.png");
			tUnchecked.LoadImage (bytes);

			bytes = System.IO.File.ReadAllBytes ("GameData/Overdrive/Textures/checked-gold.png");
			tCheckedHover.LoadImage (bytes);

			bytes = System.IO.File.ReadAllBytes ("GameData/Overdrive/Textures/unchecked-gold.png");
			tUncheckedHover.LoadImage (bytes);

			bytes = System.IO.File.ReadAllBytes ("GameData/Overdrive/Textures/border.png");
			tBorderNew.LoadImage (bytes);
		}
	}
}
